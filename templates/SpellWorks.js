 async function list_spell(event){
           try {
                ...
                const spells = await window.pywebview.api.list_Spells();// Call Python API
                console.log(spells)
        ...
        async function search_spell(event,spellSearch,toWriteTo,amt) {
            try {
                ...
                const spells = await window.pywebview.api.search_spell(spellSearch,amt); // Call Python API
                console.log(spells)
