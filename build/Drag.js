...
function createDrag() {
    ...
    if (spellCard) {
        const spellName = ((_a = spellCard.querySelector(".spell-name")) === null || _a === void 0 ? void 0 : _a.textContent) || "Unknown Spell";
        ...
        dragInfo.innerHTML = `
            ...
            <div class="DragContent">${spellCard === null || spellCard === void 0 ? void 0 : spellCard.innerHTML}</div>`;
    }
